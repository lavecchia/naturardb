...
if (JU.Logger.debuggingHigh) JU.Logger.debug (JV.binding.Binding.getMouseActionName (this.pressAction, false));
...
}if (JU.Logger.debuggingHigh) JU.Logger.debug (JV.binding.Binding.getMouseActionName (this.clickAction, false));
